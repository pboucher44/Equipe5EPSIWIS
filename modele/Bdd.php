...
define('BD', 'equipe5');       // nom de la base de données
define('LOGIN', 'root');    // login d'un utilisateur de MySql avec des droits sur la BDD
define('MDP', '');        // mot de passe de cet utilisateur
